public class TV 
{
   ...
   public void setChannel(int newChannel) 
   {
      if (on == true && newChannel >= 1 && newChannel <= 120)
       //Make sure TV is on and channel between 1 and 120
      {
         channel = newChannel;
   ...
   public void setVolume(int newVolumeLevel) 
   {
      if (on == true && newVolumeLevel >= 1 && newVolumeLevel <= 7)
       //Make sure TV is on and volume between 1 and 7
      {
   ...
   public void channelUp() 
   {
      if (on == true && channel < 120)
       //Make sure TV is on and channel is less than 120
      {                                
       //In other words, don't change the channel up
       //if the TV is not on and the channel is at its max
         channel++;
   ...
   public void channelDown() 
   {
      if (on == true && channel > 1) 
       //Make sure TV is on and channel is greater than 1
      {                              
       //In other words, don't change the channel up 
       //if the TV is not on and the channel is at its minimum
         channel--;
   ...
   public void volumeUp() 
   {
      if (on == true && volumeLevel < 7) 
       //Make sure TV is on and volume is less than 7
      {                                  
       //In other words, don't change the volume up
       //if the TV is not on and the volume is at its max
         volumeLevel++;
   ...
   {                       
      if (on && volumeLevel > 1)
       //Make sure TV is on and volume is greater than 1
      {                          
       //In other words, don't change the volume down
       //if the TV is not on and the channel is at its minimum
         volumeLevel--;
