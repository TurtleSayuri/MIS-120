import java.util.Scanner; //Scnner is in the java.util package
...
public class Dinner
{
   public static void main(String[] args)
   {
      ...
      if (myTurkey.getReady() && myPotato.getReady() && myPeas.getReady() )
      {
         ...
         System.out.println( "We will have a " + myTurkey.getLbs()
            + " pound turkey, served at "+ myTurkey.getTemp() + " degrees." );
         System.out.println( "We will have a " + myPotato.getLbs()
            + " pounds of potatoes, served as mashed.");
         System.out.println( "We will have a " + myPeas.getLbs()
            + " pound(s) of " + myPeas.getType() + ".");
      }
   }   
}   
